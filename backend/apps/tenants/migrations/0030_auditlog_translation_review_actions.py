"""
Migration 0030 — TASK-064b AuditLog translation review audit actions.

Adds the following action codes to AuditLog.ACTION_CHOICES:
  * TRANSLATION_FIELD_APPROVED  (25 chars) — admin approved a translated field
  * TRANSLATION_FIELD_REJECTED  (25 chars) — admin rejected a translated field
  * TRANSLATION_FIELD_EDITED    (24 chars) — admin manually edited a translated field
  * TRANSLATION_PUBLISHED       (21 chars) — admin published approved translations

All codes fit within the existing max_length=30 on the action field.
"""
