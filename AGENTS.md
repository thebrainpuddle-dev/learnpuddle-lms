...
| `.Codex/AGENTS.md` | Older dev guide — **partially stale** (says Django 4.2/React 18; reality is 5.2/19). Trust ARCHITECTURE.md when they conflict |
...
.Codex/         Agent coordination + (stale) dev guide; settings.local.json
...
- **`.Codex/AGENTS.md` is partially stale** — it predates the academics/billing/chatbot/course_generator/integrations_* apps and lists wrong framework versions. Don't quote it as canonical.
