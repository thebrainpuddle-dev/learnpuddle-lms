 ...
 * Adapted from upstream OpenMAIC json-repair.ts.
 */
 ...
 *  2. Find JSON structure directly in the response body
 *  3. Try parsing the whole response as-is
 ...
 * Uses 4 attempts:
 *  1. Parse as-is
 *  2. Fix LaTeX escapes & truncated JSON
 *  3. Use jsonrepair library
