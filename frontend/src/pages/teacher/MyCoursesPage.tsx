...
//
// Course catalog — polished white + orange theme.
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3">
        <div className="flex-1 max-w-sm relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-[7px] rounded-lg text-[13px] bg-white border border-gray-200 text-tp-text placeholder:text-gray-400 focus:border-tp-accent/40 focus:ring-2 focus:ring-tp-accent/10 transition-all"
          />
        </div>
          ...
          {(Object.keys(STATUS_LABELS) as StatusFilter[]).map((s) => (
            <button
              ...
              className={cn(
                ...
                statusFilter === s
                  ? 'bg-tp-accent text-white shadow-sm'
          ...
          {filtered.map((course) => {
            ...
            return (
              <button
                ...
                className="text-left bg-white rounded-2xl border border-gray-100 overflow-hidden hover:border-orange-200 hover:shadow-md transition-all group shadow-sm"
              >
              ...
              return (
                ...
                >
                  ...
                  <div className="col-span-3 flex items-center gap-2.5">
                    <div className="flex-1 h-[5px] bg-gray-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-gradient-to-r from-tp-accent to-amber-400 rounded-full"
