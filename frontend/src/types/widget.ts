 ...
 *
 * Source: THU-MAIC/OpenMAIC lib/types/widgets.ts (lifted under
 *         ADR-001a). Backend parity at
 *         backend/apps/maic/generation/widget_types.py (Pydantic
 *         port). Keep these in lockstep.
 *
 * Used by InteractiveRenderer (MAIC-605) to type the optional
 * widgetConfig prop and by the playback engine action handlers
 * (MAIC-606) to type teacherActions.
 */
