...
describe('ContentPlayer AI Classroom launch', () => {
  ...
  it('uses the linked chatbot id instead of the course content id', () => {
    window.history.pushState({}, '', '/student/courses/course-1');
    ...
    expect(screen.getByRole('link', { name: /open tutor/i }))
      .toHaveAttribute('href', '/student/chatbots/chatbot-1');
  });
});
